...
from ...db_utils import reset_autoincrement


class Command(BaseCommand):
    help = (
        'Supprime le référentiel et les rapports '
        '(sites, CP, CJ, groupes, lignes) et remet les IDs à 1. '
        'Optionnel : users / alertes.'
    )
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            '--with-alerts',
            action='store_true',
            help='Supprimer aussi alertes et notifications',
        )
